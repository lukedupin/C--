...
# Project:  C--.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile C--.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++14 -O2 -march=x86-64 -mtune=generic -O2 -pipe -fno-plt -std=gnu++1y -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -IHelpers -INodes -IParser -I. -isystem /usr/include/qt -isystem /usr/include/qt/QtCore -Imoc -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
Makefile: C--.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
moc/moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -std=c++14 -O2 -march=x86-64 -mtune=generic -O2 -pipe -fno-plt -std=gnu++1y -Wall -Wextra -dM -E -o moc/moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp
